...
public partial class @AndriodTestInput: IInputActionCollection2, IDisposable
{
    ...
    private List<IPhoneInputActions> m_PhoneInputActionsCallbackInterfaces = new List<IPhoneInputActions>();
    ...
    public struct PhoneInputActions
    {
        ...
        public void AddCallbacks(IPhoneInputActions instance)
        {
            if (instance == null || m_Wrapper.m_PhoneInputActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PhoneInputActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPhoneInputActions instance)
        {
            @Press.started -= instance.OnPress;
            @Press.performed -= instance.OnPress;
            @Press.canceled -= instance.OnPress;
        ...
        public void RemoveCallbacks(IPhoneInputActions instance)
        {
            if (m_Wrapper.m_PhoneInputActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPhoneInputActions instance)
        {
            foreach (var item in m_Wrapper.m_PhoneInputActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PhoneInputActionsCallbackInterfaces.Clear();
